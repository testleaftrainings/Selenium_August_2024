...
public class CreateLead extends ProjectSpecificMethods{
	...
	public String[][] sendData() throws IOException {
		/*
		 * //Declare the 2D Array String[][] data = new String[3][4]; data[0][0]
		 * ="TestLeaf"; data[0][1] = "Gokul"; data[0][2] = "Sekar"; data[0][3] = "99";
		 * 
		 * data[1][0] ="Qeagle"; data[1][1] = "Babu"; data[1][2] = "M"; data[1][3] =
		 * "98";
		 * 
		 * data[2][0] ="TestLeaf"; data[2][1] = "Hari"; data[2][2] = "R"; data[2][3] =
		 * "97";
		 * 
		 * return data;
		 */
		
		String[][] excelData = DataLibrary.readExcelData("CreateLead");
