...
# Steps to Create Maven Project
 ...
 - click on 'others' under 'new'
 - Expand the 'maven' folder and click on 'Maven project'
 - Enable the checkbox for 'Create a simple project' and click 'next' button
 - Enter the 'group id' which is company name (ex: org.testleaf)
 - Enter the 'Artifact id' which project name (ex: LearnSelenium , note : project name starts with uppercase or PascalCase)
...
# Steps to create package
    ...
    - Choose 'new' 
    - Click on 'package'
    - enter the package name (ex: week1.day1 , here .(dot) helps to create subfolder, note: package name starts with lowercase or camelCase)
    - Don't enable any checkbox
    - click on 'finish' button

# Steps to view package in local
    - right click on the package
    - Choose 'Show in'
    - Click on 'System explorer'.

# Steps to create class 
    - right on the package
    - choose 'new' 
    - click on  'Class'
    - enter the class name (ex: FirstProgram , class name starts with uppercase or PascalCase)
    - Enable the check box for 'main method' (public static void main (String[] args))
    - Click on the finish button

# Steps to run the java program
    - Save the program (use ctrl +s , click on save at the top left corner, right click and click on the save)
